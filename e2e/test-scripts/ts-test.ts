...
fixture('mock fixture')
    ...
    test('https://demoqa.com/ - without Request Mock', async t=> {
        await t
        ...
        for(let i=0; i<await bookNames.count; i++){
              console.log('book name ' + await bookNames.nth(i).innerText)  
        }
